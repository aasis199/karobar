...
<div class="content-page">
     <div class="container-fluid">
        ...
        <a href="http://localhost/karobar/">Home</a> / <a href="page-list-expenses.php">List Expenses</a> 
        </div>
        <div class="row p-3">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    ...
                    <a href="page-add-expenses.php" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Expenses</a>
                </div>
            </div>
            <div class="col-lg-12">
