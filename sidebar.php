...
<div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
    <a href="index.php" class="header-logo">
        <img src="assets/images/logo.png" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">Karobar Sathi</h5>
    </a>
    <div class="iq-menu-bt-sidebar ml-0">
        <i class="las la-bars wrapper-menu p-2"></i>
    </div>
</div>
<div class="data-scrollbar" data-scroll="1">
    <nav class="iq-sidebar-menu">
        <ul id="iq-sidebar-toggle" class="iq-menu">
            <li class="active">
                <a href="http://localhost/karobar/" class="svg-icon">                        
                ...
                <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                    ...
                    <li class="">
                                <a href="page-list-category.php">
                                    <i class="las la-minus"></i><span>Item Groups</span>
                                </a>
                        </li>
                </ul>
            </li>
            <!-- <li class=" ">
                ...
                <ul id="orders" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                    <li class="">
                        <a href="page-list-orders.php">
                            <i class="las la-minus"></i><span>Orders</span>
                        </a>
                    </li>
                </ul>
            </li> -->
                ...
                <ul id="purchase" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="">
                                <a href="page-list-purchase.php">
                                    <i class="las la-minus"></i><span>Purchase Order</span>
                                </a>
                        </li>
                        <li class="">
            ...
            <li class=" ">
                ...
                <ul id="sale" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="">
                                <a href="page-list-orders.php">
                                    <i class="las la-minus"></i><span>Sales Orders</span>
                                </a>
                        </li>
                        <li class="">
                        ...
                        <!-- <li class="">
                                <a href="page-list-sale.php">
                                    <i class="las la-minus"></i><span>Shipments</span>
                                </a>
                        </li>
                        <li class="">
                                <a href="page-list-sale.php">
                                    <i class="las la-minus"></i><span>Sales Returns</span>
                                </a>
                        </li> -->
                </ul>
            </li>
