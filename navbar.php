<div class="iq-top-navbar">
    <nav class="navbar navbar-expand-lg navbar-light p-0">
        <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
            ...
            <a href="http://localhost/karobar/index.php" class="header-logo">
                <img src="http://localhost/karobar/assets/images/logo.png" class="img-fluid rounded-normal" alt="logo">
                <h5 class="logo-title ml-3">Karobar Sathi</h5>
        ...
        <div class="d-flex align-items-center">
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          <ul class="navbar-nav ml-auto navbar-list align-items-center">
                            <p id="time" class="mt-3"></p>
                            <li >
                                <a href="page-add-sale.php" class="btn border add-btn shadow-none mx-2 d-none d-md-block">
                                    <i class="las la-plus"></i><span>Create Invoices</span>
                                </a>
                        </li>
                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <img src="http://localhost/karobar/assets/images/user/asis.jpg" class="img-fluid rounded mt-2" alt="user">
                                  </a>
                                  <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-0 text-center">
                                              <div class="media-body profile-detail text-center">
                                                  <img src="http://localhost/karobar/assets/images/page-img/bg.jpeg" alt="profile-bg" class="rounded-top img-fluid mb-4 h-50">
                                                  <img src="http://localhost/karobar/assets/images/user/asis.jpg" alt="profile-img" class="rounded profile-img img-fluid avatar-70">
                                              </div>
                                              <div class="p-3">
                                                  <h5 class="mb-1">Aashish Pandey</h5>
